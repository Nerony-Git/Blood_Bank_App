            ...
            <div class="breadcrumbs">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="<%=request.getContextPath()%>/donor_requests">  Request Blood </a></li>
                        <li class="breadcrumb-item active" aria-current="page">  View Request Details</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-md-8 offset-md-2">
                <div class="card bg_border">
                    <div class="card-header text-center">
                        <img class="bg_img" src="assets/img/web/blood_request_details.png" alt="Request blood title">
