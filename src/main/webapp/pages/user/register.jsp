...
<head>
    ...
    <title>Blood Bank - User Registration</title>
            ...
            <div class="col-md-8 offset-md-2">
                <div class="card bg_border mb-5">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form -->
                        <form action="<%=request.getContextPath()%>/new_user" method="post">
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <!-- End Form -->
                        <br/>
                        <p>Already have an account? <a href="<%=request.getContextPath()%>/user_login" class="text-decoration-none">Login</a></p>
                    </div>
                </div>
            </div>
        </div>
