                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="firstName" class="form-control" aria-label="First Name" aria-describedby="firstName" readonly value="${user.firstName}">
                                </div>

                                <label class="form-label" for="lastName">Last Name</label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="lastName"><i class="fa-solid fa-user"></i> </span>
                                    <input type="text" name="lastName" class="form-control" aria-label="Last Name" aria-describedby="lastName" readonly value="${user.lastName}">
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="otherName" class="form-control" aria-label="Other Name" aria-describedby="otherName" readonly value="${user.otherName}">
                                </div>

                                <label class="form-label" for="username">Username</label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="username"><i class="fa-solid fa-user-tag"></i> </span>
                                    <input type="text" name="username" class="form-control" aria-label="First Name" aria-describedby="firstName" readonly value="${user.username}">
                                </div>

                                <label class="form-label" for="address">Address</label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="address"><i class="fa-solid fa-map-location-dot"></i> </span>
                                    <input type="text" name="address" class="form-control" aria-label="Address" aria-describedby="address" readonly value="${user.address}">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="dob" class="form-control" aria-label="Date of Birth" aria-describedby="dob" readonly value="${user.dob}">
                                </div>

                                <label class="form-label" for="gender">Gender</label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="gender"><i class="fa-solid fa-venus-mars"></i> </span>
                                    <input type="text" name="gender" class="form-control" aria-label="Gender" aria-describedby="gender" readonly value="${user.gender}">
                                </div>

                                <label class="form-label" for="contact">Contact</label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="contact"><i class="fa-solid fa-phone-volume"></i> </span>
                                    <input type="text" name="contact" class="form-control" aria-label="Contact" aria-describedby="contact" readonly value="${user.contact}">
                                </div>

                                <label class="form-label" for="email">Email</label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="email"><i class="fa-solid fa-envelope"></i> </span>
                                    <input type="text" name="email" class="form-control" aria-label="Email" aria-describedby="email" readonly value="${user.email}">
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="postalAddress" class="form-control" aria-label="Postal Address" aria-describedby="postalAddress" readonly value="${user.postalAddress}">
                                </div>

                                <label class="form-label" for="bloodGroup">Blood Group</label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="bloodGroup"><i class="fa-solid fa-staff-snake"></i> </span>
                                    <input type="text" name="bloodGroup" class="form-control" aria-label="Blood Group" aria-describedby="bloodGroup" readonly value="${user.bloodGroup}">
                                </div>
                                <br/>
                                <br/>
