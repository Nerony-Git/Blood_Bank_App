...
<head>
    ...
    <title>Blood Bank - Edit Camp Details</title>
            ...
            <div class="breadcrumbs">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">  Edit Camp Details </li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-md-6 offset-md-3">
                <div class="card bg_border">
                    <div class="card-header text-center">
                        <img class="bg_img" src="assets/img/admin/edit_donation_camp.png" alt="Donation title">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form -->
                        <form action="<%=request.getContextPath()%>/update_camp" method="post">
                            ...
                            <input type="hidden" name="donationCampID" value="${donationCamp.campID}">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="donationCampName" class="form-control" aria-label="Donation Camp Name" aria-describedby="donationCampName" required value="${donationCamp.campName}">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="organizers" class="form-control" aria-label="Organizers" aria-describedby="organizers" required value="${donationCamp.organizers}">
                            </div>

                            <label class="form-label">Address</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="address"><i class="fa-solid fa-map-location-dot"></i> </span>
                                <input type="text" name="address" class="form-control" aria-label="Address" aria-describedby="address" required value="${donationCamp.address}">
                            </div>

                            <label class="form-label">Postal Address</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="postalAddress"><i class="fa-solid fa-street-view"></i> </span>
                                <input type="text" name="postalAddress" class="form-control" aria-label="Postal Address" aria-describedby="postalAddress" required value="${donationCamp.postal_address}">
                            </div>

                            <label class="form-label">Details</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="details"><i class="fa-solid fa-text-width"></i> </span>
                                <textarea name="details" class="form-control" rows="4" aria-label="Details" aria-describedby="details" required >${donationCamp.details}</textarea>
                            </div>
                            <br/>
                            <div class="input-group justify" style="justify-content: center;">
                                <button type="submit" class="bg_btn">&nbsp;<i class="fa-solid fa-tent"></i> &nbsp; Update Donation Camp &nbsp;</button>
                            </div>
                            <br/>
                            <br/>
