...
<head>
  ...
  <title>Blood Bank - Edit Request Details</title>
      ...
      <div class="breadcrumbs">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="<%=request.getContextPath()%>/view_new_requests"> New Blood Requests </a></li>
            <li class="breadcrumb-item active" aria-current="page">Edit Blood Request Details</li>
          </ol>
        </nav>
      </div>
    </div>
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card bg_border">
                <div class="card-header text-center">
                    <img class="bg_img" src="assets/img/admin/process_blood_request.png" alt="Request blood title">
                ...
                <div class="card-body">
                    ...
                    <!-- Form -->
                    <form action="<%=request.getContextPath()%>/update_request" method="post">
                      <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <div class="input-group mb-3">
                              <span class="input-group-text" id="status"><i class="fa-solid fa-heart-pulse"></i> </span>
                              <select class="form-select" name="status" aria-label="Donation Camp" aria-describedby="status">
                                <option selected disabled> ${bloodRequest.status} </option>
                        ...
                        <div class="input-group mb-3">
                          ...
                          <div class="input-group justify" style="justify-content: center;">
                              <button type="submit" class="bg_btn">&nbsp; &nbsp;<i class="fa-solid fa-gears"></i> &nbsp; Process Request &nbsp; &nbsp;</button>
                          </div>
                          <br/>
                          <br/>
                      </div>
