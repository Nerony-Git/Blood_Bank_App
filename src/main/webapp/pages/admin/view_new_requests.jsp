...
<head>
  ...
  <title>Blood Bank - New Requests</title>
      ...
      <div class="breadcrumbs">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">  New Blood Requests </li>
          </ol>
        </nav>
      </div>
    </div>
      ...
      <div class="card bg_border">
        ...
        <div class="card-body">
          ...
          <table class="table table-striped table-hover">
            ...
            <tbody>
            <c:forEach var="donorRequest" items="${allNewBloodRequests}">
              <tr>
