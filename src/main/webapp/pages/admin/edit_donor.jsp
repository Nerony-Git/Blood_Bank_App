...
<head>
    ...
    <title>Blood Bank - Edit Donor Profile</title>
            ...
            <div class="col-md-8 offset-md-2">
                <div class="card bg_border">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form -->
                        <form action="<%=request.getContextPath()%>/update_donor" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" name="uID" value="${donor.donorID}">

                                    <label class="form-label" for="firstName">First Name</label>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="firstName"><i class="fa-solid fa-user"></i> </span>
                                        <input type="text" name="firstName" class="form-control" aria-label="First Name" aria-describedby="firstName" required value="${donor.firstName}">
                                    </div>

                                    <label class="form-label" for="lastName">Last Name</label>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="lastName"><i class="fa-solid fa-user"></i> </span>
                                        <input type="text" name="lastName" class="form-control" aria-label="Last Name" aria-describedby="lastName" required value="${donor.lastName}">
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="otherName" class="form-control" aria-label="Other Name" aria-describedby="otherName" value="${donor.otherName}">
                                    </div>

                                    <label class="form-label" for="username">Username</label>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="username"><i class="fa-solid fa-user-tag"></i> </span>
                                        <input type="text" name="username" class="form-control" aria-label="Username" aria-describedby="username" readonly value="${donor.username}">
                                    </div>

                                    <label class="form-label" for="address">Address</label>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="address"><i class="fa-solid fa-map-location-dot"></i> </span>
                                        <input type="text" name="address" class="form-control" aria-label="Address" aria-describedby="address" required value="${donor.address}">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="date" name="dob" class="form-control" aria-label="Date of Birth" aria-describedby="dob" required value="${donor.dob}">
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="gender" class="form-select" aria-label="Gender" aria-describedby="gender" required>
                                            <option selected="selected">${donor.gender}</option>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="contact" class="form-control" aria-label="Contact" aria-describedby="contact" required value="${donor.contact}">
                                    </div>

                                    <label class="form-label" for="email">Email</label>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="email"><i class="fa-solid fa-envelope"></i> </span>
                                        <input type="text" name="email" class="form-control" aria-label="Email" aria-describedby="email" required value="${donor.email}">
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="postalAddress" class="form-control" aria-label="Postal Address" aria-describedby="postalAddress" required value="${donor.postalAddress}">
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="bloodGroup" class="form-select" aria-label="Blood Group" aria-describedby="bloodGroup" required>
                                            <option selected="selected"> ${donor.bloodGroup} </option>
