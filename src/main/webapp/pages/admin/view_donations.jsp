...
<head>
  ...
  <title>Blood Bank - View Donations</title>
      ...
      <div class="breadcrumbs">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">  Blood Donations </li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <div class="row">
      <div class="card bg_border">
        <div class="card-header text-center">
          <img class="bg_img" src="assets/img/admin/view_blood_donated.png" alt="View donations title.">
        </div>
        ...
        <div class="card-body">
          ...
          <table class="table table-striped table-hover">
            ...
            <tbody>
            <c:forEach var="donation" items="${allBloodDonations}">
              <tr>
